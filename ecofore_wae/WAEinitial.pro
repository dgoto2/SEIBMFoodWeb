FUNCTION WAEinitial, Npop, nWAE, TotBenBio, NewInput, nGridcell
;this function initializes the data for walleye

PRINT, 'WAEinitial Starts Here'
...
;IF(LAG0count GT 0.) THEN Length[LAG0] = RANDOMU(seed, LAG0count) * (MAX(20) - MIN(15)) + MIN(15)
...
opt_rho[*]=(0.1298 * ALOG((WAE[1, *])) - 0.0853); optrho
;print, min(opt_rho)
...
WAE[64, *] = 0.0; starvation mortality
WAE[65, *] = 0.0; background predation mortality
