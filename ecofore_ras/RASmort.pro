FUNCTION RASmort, length, stor, struc, no_inds, nRAS, td, ts, DOa, DOacclR, DOstressR, LIGHT

PRINT, 'RASmort Begins Here'
...
TotMort = FLTARR(4, nRAS)
TotMort[0,*] = ROUND(pred)
TotMort[1,*] = ROUND(star)
TotMort[2,*] = ROUND(suff)
TotMort[3,*] = PrMORT
;PRINT, 'TotMort =', TotMort

PRINT, 'RASmort Ends Here'
RETURN, TotMort
END