FUNCTION YEPFishPreyArray1D, YP, EMS, RAS, ROG, WAE, nYP, nGridcell
; Creat a fish prey array

PRINT, 'YEPFishPreyArray1D Begins Here'
...
;    multiSIprey = WHERE(ROG[1, multiSI] LT (0.2*YP[1, multiSI[ID2]]), multiSIpreycount);
...
PRINT, 'YEPFishPreyArray1D Ends Here'
RETURN, FISHPREY
END