...
if year eq '87' then begin
  nDays   = 182.    ; how many days the model ran
...
contour,DOplotter,daysX,depthY,levels=levelsDO,yrange=[47,0],/fill,title='DO (mg L!U-1!N), '+longyear,$
        ...
        ytickname=['20','15','10','5','0'],ytitle='Depth (m)',xtickv=[0,30,60,90,120,150,nDays-1],$
        xtickname=['Jun','Jul','Aug','Sep','Oct','Nov','Dec'],color=0,xminor=1,xticks=6,$
...
contour,Tplotter,daysX,depthY,levels=levelsT,yrange=[47,0],/fill,title='Temperature (!Uo!NC), '+longyear,$
        ...
        xtickname=['Jun','Jul','Aug','Sep','Oct','Nov','Dec'],color=0,xminor=1,xticks=6,$
        xmargin=[10,15],ymargin=[4,4]
colorbar,bottom=0,color=0,divisions=5,maxrange=26.5,ncolors=255,minor=1,position=[0.89,0.08,0.94,0.92],$
         ticknames=['0','5','10','15','20','25'],/right,/vertical
