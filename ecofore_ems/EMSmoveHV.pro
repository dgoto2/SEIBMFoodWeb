...
;function determines movement in X,Y,Z direction for all EMERALD SHINER
...
NewFishEnviron[8, *] = TotBenBio[EMS[14, *]];YP[14, *] New TotBenBio
...
PRINT, 'Emerald Shiner Movement Ends Here'
